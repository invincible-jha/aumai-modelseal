# Agent Instructions for Modelseal

## Project Context
Modelseal is an open source Cryptographic signing and verification for ML model artifacts.

## Repository Layout
- `src/aumai_modelseal/` — package source
